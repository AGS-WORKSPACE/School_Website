...
export const roleCatalogue: Role[] = [
  ...
  },
  {
    ...
    description: "Processes applications, screening and recommended admission batches within scope.",
    permissionIds: [
  ...
  },
  {
    ...
    workspace: "admissions",
    description: "Registrar-side authority that approves recommended admission batches.",
    permissionIds: ["admissions:application:read", "admissions:batch:approve"],
    assignableDimensions: ["institution"],
    privileged: true,
    breakGlassOnly: false,
  },
