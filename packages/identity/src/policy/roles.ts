...
export const roleCatalogue: Role[] = [
  ...
  },
  {
    ...
    permissionIds: ["records:result:approve", "records:transcript:issue", "records:student-record:approve", "records:graduation:approve", "identity:person:read"],
    assignableDimensions: ["institution", "faculty"],
    privileged: true,
    breakGlassOnly: false,
  },
  {
    id: "graduation-officer",
    name: "Graduation officer",
    workspace: "records",
    description:
      "Runs graduation audits, prepares graduand lists and transcripts, and keeps certificate stock. Approval, signing and sealing sit with records approvers.",
    permissionIds: ["records:graduation:audit", "records:transcript:prepare", "records:certificate:manage", "identity:person:read"],
    assignableDimensions: ["institution"],
    privileged: false,
    breakGlassOnly: false,
  },
  {
    ...
    workspace: "records",
    description: "Decides one unit's graduation clearance checkpoint: Bursary, Library, Department, Student Affairs, Hostel, ICT or Registry.",
    permissionIds: ["records:clearance:decide"],
    assignableDimensions: ["institution", "faculty", "department"],
    privileged: false,
    breakGlassOnly: false,
  },
  {
    ...
    permissionIds: ["records:student-record:amend", "records:hold:manage", "records:registration:freeze", "identity:person:read"],
    assignableDimensions: ["institution", "faculty"],
    privileged: false,
    breakGlassOnly: false,
  },
  ...
  },
  {
    ...
    workspace: "academics",
    description:
      "Reviews registration exceptions and academic risk for assigned advisees. Sees holds and standing relevant to registration, never counselling, health or disciplinary detail.",
    permissionIds: ["academics:registration:advise", "lms:enrolment:read"],
    assignableDimensions: ["department"],
    privileged: false,
    breakGlassOnly: false,
  },
  ...
  },
  {
    ...
    workspace: "lms",
    description: "Reviews the security and data contract of learning-tool integrations and activates or suspends them, and approves the DPIA a proctoring control needs before it may run.",
    permissionIds: ["lms:integration:approve", "lms:integrity:dpia-approve"],
    assignableDimensions: ["institution"],
    privileged: true,
    breakGlassOnly: false,
  },
  {
    id: "learner-support-officer",
    name: "Learner support officer",
    workspace: "lms",
    description: "Responds to transparent engagement alerts for online learners and routes them to a human. Holds no permission that changes academic standing.",
    permissionIds: ["lms:engagement:respond", "lms:enrolment:read"],
    assignableDimensions: ["institution", "faculty", "department"],
    privileged: false,
    breakGlassOnly: false,
  },
  {
    ...
    name: "Online tutor",
    workspace: "lms",
    description: "Holds a caseload of assigned online learners: their participation, submissions and contact history, and nobody else's.",
    permissionIds: ["lms:caseload:export", "lms:enrolment:read"],
    assignableDimensions: ["department", "programme", "cohort"],
    privileged: false,
    breakGlassOnly: false,
  },
  {
    id: "online-assessment-coordinator",
    name: "Online assessment coordinator",
    workspace: "lms",
    description: "Configures identity and integrity controls for online assessments in proportion to risk, and issues the learner-facing notice, practice path and appeal route.",
    permissionIds: ["lms:integrity:configure", "lms:enrolment:read"],
    assignableDimensions: ["department"],
    privileged: false,
    breakGlassOnly: false,
  },
  {
    ...
    workspace: "lms",
    description: "Reads suppressed, cohort-safe course evaluation and outcome/engagement reports, and grants time-bounded read-only evidence access to accreditation reviewers.",
    permissionIds: ["lms:evaluation:read", "lms:evidence:grant"],
    assignableDimensions: ["institution"],
    privileged: false,
    breakGlassOnly: false,
  },
