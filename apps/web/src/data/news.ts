...
export const news: NewsArticle[] = [
  {
    ...
    content: [
      "Nnamdi Azikiwe University has inaugurated a state-of-the-art Clinical Simulation Centre at its Awka campus, a facility designed to immerse students in realistic, high-stakes clinical environments long before they enter the wards.",
    ...
    authorRole: "NAU Public Relations",
  ...
  },
  {
    ...
    title: "NAU Researchers Publish Landmark Study on Neglected Tropical Diseases",
    excerpt:
    ...
    content: [
      "A team of epidemiologists and biomedical scientists from Nnamdi Azikiwe University has published a landmark study on the control of neglected tropical diseases in southeastern Nigeria.",
      ...
      "Findings from the study have been adopted into regional treatment guidelines and underscore NAU's growing reputation as a centre for infectious disease research.",
    ],
    category: "Research",
  ...
  },
  {
    ...
    title: "NAU Nursing Class Records 100% Licensure Pass Rate",
    excerpt:
  ...
  },
  {
    ...
    title: "NAU Innovation Hub Wins Pan-African Health Technology Award",
    excerpt:
      "The NAU Innovation Hub has been recognised for its low-cost neonatal monitoring device, developed by students and faculty for use in rural Nigerian clinics.",
    content: [
      "The NAU Innovation Hub has won a Pan-African Health Technology Award for a low-cost neonatal monitoring device designed for use in rural clinics without reliable power.",
      ...
      "The award places NAU among a select group of African institutions recognised for translating academic research into accessible medical technology.",
    ],
    category: "Innovation",
    image: "/images/placeholders/news-3.jpg",
