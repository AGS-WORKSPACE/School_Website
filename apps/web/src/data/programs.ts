...
export const programs: Program[] = [
  {
    ...
    subject: "Medicine",
    entryRoutes: ["UTME", "Direct Entry", "International"],
    accreditationStatus: "MDCN recognised",
    facultyId: "medicine",
    ...
    applicationRequirements: [
      ...
      "Academic results and a recent passport photograph",
    ],
    importantDates: [
      { label: "Application deadline", date: "31 July 2026" },
      { label: "Screening", date: "Dates shared after application review" },
    ],
  ...
  },
  {
    ...
    subject: "Nursing",
    entryRoutes: ["UTME", "Direct Entry", "International"],
    accreditationStatus: "NMCN recognised",
    facultyId: "nursing",
    ...
    importantDates: [{ label: "Application deadline", date: "31 July 2026" }],
  ...
  },
  {
    ...
    entryRoutes: ["Postgraduate", "International"],
    accreditationStatus: "NUC accredited",
    ...
    applicationRequirements: [
      ...
      "Curriculum vitae and two referee contacts",
    ],
    importantDates: [{ label: "Application deadline", date: "30 September 2026" }],
  ...
  },
  {
    ...
    applicationRequirements: [
      "Completed online application form",
      "Master's degree certificate and academic transcript",
      "Research proposal and supervisor preference",
    ],
    importantDates: [{ label: "Application deadline", date: "30 September 2026" }],
  ...
  },
  {
    ...
    entryRoutes: ["Residency"],
    accreditationStatus: "Accredited training pathway",
    facultyId: "medicine",
    duration: "5 Years",
    mode: "Full-time",
    description:
    ...
    applicationRequirements: [
      ...
      "MBBS certificate and evidence of medical registration",
      "Curriculum vitae and examination evidence",
    ],
    importantDates: [{ label: "Application window", date: "Published by the Residency Office" }],
...
export const publishedPrograms = programs.filter((program) => program.publicationStatus === "published");
