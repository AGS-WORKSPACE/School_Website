...
export const navigation: NavGroup[] = [
  ...
  {
    label: "Online Learner Support",
    items: [
      {
        href: "/online-learning/engagement",
        label: "Engagement alerts",
        description: "Transparent, rule-explained alerts routed to a human — never an automatic standing change.",
        icon: Radar,
      },
      {
        href: "/online-learning/caseload",
        label: "Tutor caseload",
        description: "Each tutor's own assigned learners: participation, submissions and contact attempts.",
        icon: HeartHandshake,
      },
      {
        href: "/online-learning/integrity",
        label: "Assessment integrity",
        description: "Identity and integrity controls scaled to risk, with DPIA approval before proctoring runs.",
        icon: ScanEye,
      },
      {
        href: "/online-learning/evaluation",
        label: "Evaluation & outcome reports",
        description: "Cohort-safe course evaluation compared by delivery mode, without implying causation.",
        icon: LineChart,
      },
      {
        href: "/online-learning/evidence",
        label: "Accreditation evidence access",
        description: "Time-bounded, scoped, read-only evidence grants for accreditation reviewers.",
        icon: Eye,
      },
    ],
  },
