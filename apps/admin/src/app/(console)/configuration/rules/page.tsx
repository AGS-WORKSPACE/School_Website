...
export default function AcademicRulesPage() {
  ...
  return <>
    <PageHeader eyebrow="CFG-04" title="Academic and policy rules" description="Manage academic and policy rules." actions={<Button onClick={() => createRuleVersion("programme-approval")}><Plus /> New rule version</Button>} />
