...
export default function AcademicCalendarPage() {
  ...
  return <>
    <PageHeader eyebrow="CFG-02" title="Academic calendar" description="Configure sessions, terms, teaching weeks, deadlines and programme variations without rewriting past calendars." actions={<Button onClick={() => setWizard(true)}><Plus /> Create session</Button>} />
