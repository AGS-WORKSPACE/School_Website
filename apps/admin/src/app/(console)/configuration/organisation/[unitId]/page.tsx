...
export default function OrganisationDetailPage() {
  ...
  return <>
    ...
    <PageHeader eyebrow={`${unit.type} · ${unit.id}`} title={unit.name} description="Effective-dated unit record, reporting relationships and retained history." actions={<><Button variant="outline" onClick={() => setEditing(true)}>Edit draft version</Button><Button onClick={() => setEditing(true)}><Plus /> Add child unit</Button></>} />
