...
export default function RegistrationOfferingsPage() {
  ...
  return <div className="space-y-6">
    <PageHeader eyebrow="EP-10 · REG-01" title="Semester course offerings" description="Create department offerings with lecturer, capacity and delivery mode. Approved capacity may not exceed the validated room/online/staff constraint without a recorded exception." actions={<Badge variant="outline">Frontend workflow</Badge>} />
