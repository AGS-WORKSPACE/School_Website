...
export default function RegistrationStatementsPage() {
  ...
  return <div className="space-y-6">
    <PageHeader eyebrow="EP-10 · REG-05" title="Frozen registration statements" description="Freeze each term's approved registration into an exact, versioned statement. Later corrections append an amendment; the original is never rewritten." actions={<Badge variant="outline">Frontend workflow</Badge>} />
