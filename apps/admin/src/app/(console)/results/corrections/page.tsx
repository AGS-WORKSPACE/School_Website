...
export default function ResultCorrectionsPage() {
  ...
  return <div className="space-y-6">
    <PageHeader eyebrow="EP-12 · RES-06" title="Result corrections and history" description="Review result corrections and history." actions={<Badge variant="outline">Preview</Badge>} />
