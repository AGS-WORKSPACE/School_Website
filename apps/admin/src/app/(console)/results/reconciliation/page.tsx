...
export default function ResultReconciliationPage() {
  ...
  return <div className="space-y-6">
    <PageHeader eyebrow="EP-12 · RES-07" title="Result reconciliation workspace" description="Compare SIS and LMS records against the approved result source. External data is reported for review and never silently written back." actions={<Badge variant="outline">Frontend workflow</Badge>} />
