...
export default function ResultBatchesPage() {
  ...
  return <div className="space-y-6">
    <PageHeader eyebrow="EP-12 · RES-04" title="Result batch workspace" description="Prepare and approve result batches." actions={<Badge variant="outline">Preview</Badge>} />
