...
export default function ScreeningAppointmentsPage() {
  ...
  return <div className="space-y-6"><Link href="/admissions/screening" className="inline-flex items-center text-sm font-semibold text-muted-foreground hover:text-primary"><ArrowLeft className="mr-1.5 size-4" />Back to screening workspace</Link><PageHeader eyebrow="EP-06 · SCR-03" title="Screening appointments and attendance" description="Schedule screenings and record attendance." actions={<Badge variant="outline"><CalendarDays className="mr-1 size-3.5" />Scheduling preview</Badge>} />{message && <div className="rounded-lg border border-primary/20 bg-primary/5 px-4 py-3 text-sm" role="status">{message}</div>}
